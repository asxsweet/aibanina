...
interface DreamsModalProps {
  ...
  /** When true, renders just the inner list/form with no fixed overlay,
   *  backdrop or close button — for embedding inline inside the admin
   *  dashboard instead of popping up as a modal. */
  embedded?: boolean;
}
...
export const DreamsModal: React.FC<DreamsModalProps> = ({ isOpen, onClose, currentUserName, embedded = false }) => {
