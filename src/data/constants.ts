...
export const DAILY_MESSAGES: DailyMessage[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    dayNumber: 33,
    title: 'Жаратылыс',
    text: 'Алла Тағала барлық жаратылысты жұп жұп етіп жаратқан,от-су,салқын жылы,қатты-жұмсақ,тәтті-ашшы,таумен-тас,сен және мен,яғни жұптар бір бірінің орнынын толтырады менің орнымды сен толтырсаң,сенің орныңды мен толтырайын',
    hint: 'Алла Тағаланың сөзі хақ'
  },
   {
    id: 34,
    dayNumber: 34,
    title: 'Хайырлысы part 1',
    text: 'Қазіргі кезде барлығы зина жасап жатқан заманда біз екеуімізде солардың қатарына кіріп кетпес үшін арақашықтық беріп қойғаны хайырлысы шығар',
    hint: 'Бізге ең жақсысы не екенін өзіміздің жаратушымыздан басқа ешкім білмейді'
  },
    {
    id: 35,
    dayNumber: 35,
    title: 'Хайырлысы part 2',
    text: 'Алла тағаланың қалауымен сені аманат етіп алсам деймін,халал және үйленуге ниеті бар хайырлы жолмен. ',
    hint: 'Өмірлік адамым'
  },
   {
    id: 36,
    dayNumber: 36,
    title: 'Басты кетіреді',
    text: 'Сүйген адамыңды сағынасың,іздейсің күні түні ойлайсың және кездесуді аңсап күтесің,бұл қашаннан бері ауру деп айтылатын болған?',
    hint: 'Сенде осындай ауру болған ба?'
  },
   {
    id: 37,
    dayNumber: 37,
    title: 'Түсінік part 1',
    text: 'Шынайы махаббат дегеніміз не? Ол тек ләззат алу мақсатында ма? Ал тереңірек түсінетін болсақ ше? Тек сол адамды ғана өміріңнің соңына дейін ешқандай изменасыз тек ессіз сүю,оны әрдайым күту,іздеу, бауырыңа басып иіскеуің,ол адамға шынайы қамқор болуың бұл бөлек сезім солай емес пе? ',
    hint: 'Ғашық адамның көзіне сүйген адамынан басқа ешкім көрінбейді емес пе?'
  },
  {
    id: 38,
    dayNumber: 38,
    title: 'Түсінік part 2',
    text: 'Бұндай түсінік қазіргі бір барни үшін әйелін өлтірген заманда,бір ессіз естіледі ия,бірақ бұл оқиғамен барлық адамдар бірдей деп тұжырым жасауда ессіз естіледі. ',
    hint: 'Мен ондай адам болмасам да,мені толықтай зерітте,мен туралы түсінік қалыптастыр.'
  },
   {
    id: 39,
    dayNumber: 39,
    title: 'Кездестік делік',
    text: 'Бірінші кездесуден көре сала бір бірімізбен құшақтасу саған қалай нормально ма? я хочу обнять но если тебе не удобно или не нормално пусть все так как ты желаешь! ',
    hint: 'Сіздің сөзіңіз заң!'
  },
   {
    id: 40,
    dayNumber: 40,
    title: 'Сүйгенім',
    text: 'Сені қатты қатты жақсы көрем,қай жерде жүрсемде тек сені ойлаймын күтемін уже не могу без тебя',
    hint: 'Дуалап алмадың ба айтеуір?'
  },
   {
    id: 41,
    dayNumber: 41,
    title: 'Ойымдасың және дұғамдасың',
    text: 'Мен сені әрдайым дуалаймын,намазсайын Алла тағаладан сенің амандығыңмен тек сенің хайырлы(менікі)болуыңды сұраймын',
    hint: 'Періштелер Әминь десе менікі болып тұрсыз ғо бұйыртса!'
  },
    {
    id: 42,
    dayNumber: 42,
    title: 'Хор қыздары',
    text: 'Жаннаттағы хор қыздары туралы ойың қалай?',
    hint: 'Егер жаннати болып жатсақ сен мені олардан қызғанасың ба?'
  }
