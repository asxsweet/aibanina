...
export const DAILY_MESSAGES: DailyMessage[] = [
  ...
  },
  {
    ...
    text: 'Сенің қасыңда кішкентай баламын , әр айтқан әзілдерңе балаша шынайы күле аламын,кейде ұяламын но если это ты то могу вечно смущаться над твой шуткой.',
  ...
  },
  {
    ...
    dayNumber: 17,
    title: 'Егер...',
    text: 'Я рад что бұйыртса у нас будут прекрасные дети потому что их мать такой очаровательная что они будет похожи на тебя.',
  ...
  },
  {
    ...
    dayNumber: 20,
    title: 'Комфорт+',
    text: 'Я хочу, чтобы ты рядом со мной чувствовал себя комфортно и уютно',
    hint: 'Жылуым.'
  },
  {
    id: 21,
    dayNumber: 21,
    title: 'Сенім=доверия',
    text: 'Ты можешь положиться на меня. Ты можешь рассказать, как прошёл твой день, что интересного было, кто тебя обидел, устала ли ты — всё, что можешь рассказать, арамыз көптеген шақырымдар болсада,әрқашан жылу беруге дайынмын.',
  ...
  },
  {
    ...
    text: 'Самая, самая, самая прекрасная девушка. Никто не сравнится с твоей красотой, саған әрдайым қарап отырғым келеді. ',
    hint: 'Моя очаровательная леди.'
  },
  {
    id: 26,
    dayNumber: 26,
    title: 'Влюбиться в тебя',
    text: 'Ғашықпын сол адамға, Көрмесем оны тұра алам ба,Әйтеуір бір кездесерміз,Сол өзің айтып жүрген сұлу деген қалаңда.',
    hint: 'Ақын боп кеткем ба?:)'
  },
  {
    id: 27,
    dayNumber: 27,
    title: 'Stars',
    text: 'Жұлдыздар өте көп бірақ қолым жеткен жалғыз жұлдыз тек - сен  ',
    hint: 'Жарқырған жұлдызым.'
  },
  {
    id: 28,
    dayNumber: 28,
    title: 'Wonderful',
    text: 'О боже, какая же у меня красивая девушка… Мне до сих пор кажется, что я сплю❤️',
    hint: 'Басымды айналдырған тентек қыз.',
    voiceUrl: '/voice/day-28.mp3'
  },
  {
    id: 29,
    dayNumber: 29,
    title: 'Мыңдаған жылы сөздер',
    text: 'Арнадым саған бір өлең,ақын болмасам да,Айды алып берер едім,Қолым жетпей тұрса да.',
    hint: 'My love.'
  },
  {
    id: 30,
    dayNumber: 30,
    title: 'Қорытынды ',
    text: 'Моя солнце,моя звезда,менің күнімді жарқырататын жан,30 күнде,30 түрлі сезім, сөздерімді бұнымен аяқтамаймын,постараюсь что менің сөздерім сіздіңде күніңізді жарқырататынына,тек әрдайым күлімдеп жүр. '
    hint: 'Саған күлімдеген жарасады ❤️' 
  },


  
  // ==========================================
  // ТАРАУ 2 — жаңа аспан ашылады (31-күннен бастап)
  // ==========================================
  ...
  
  {
    id: 31,
    dayNumber: 31,
    title: '2 тарау is starting',
    text: 'Дальше жалғастыру үшін маған көп кітап оқу керек,и сені зерттеу керек білу керек,болмаса бір бірімізді қинамай үйлене салайық деппа ,сильное заявление было.',
    hint: 'Ладно әзіл әзілмен но мойындаш осыған дейінгілерді әзіл деп ғана қабылдадың ба нет?'
  },
  {
    id: 32,
    dayNumber: 32,
    title: 'Твой наряд',
    text: 'Ты даже представить не можешь что когда ты өзіңнің образынды көрсеткенде ой ой мен құлаймын,Ты слишком красивая для меня. Кажется, я тебя недостоин. ',
    hint: 'Флирт деп осыны айт'
  }
];
