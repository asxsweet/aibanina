...
export const DAILY_MESSAGES: DailyMessage[] = [
  ...
  },
  {
    ...
    text: 'Ғашықпын сол адамға, Көрмесем оны тұра алам ба,Әйтеуір бір кездесерміз,Сол өзің айтып жүрген сұлу қалаңда.',
  ...
  },
  {
    ...
    dayNumber: 28,
    title: 'COOL',
    text: 'Кейде суықсың,кейде тәттісің ,қолым жетіп тұрсада тым алыстасың,',
